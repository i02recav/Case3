...
namespace calculator.frontend.Controllers
{
    public class SquareRootController : Controller
    {
        ...
        private double ExecuteOperation(string operation, double num1)
        {
            var result = 0.0;
        ...
        [HttpPost]
        public ActionResult Index(string firstNumber, string operation)
        {
            double num1 = Convert.ToDouble(firstNumber);
            ViewBag.Result = ExecuteOperation(operation, num1);
            return View();
        }
    }
}
